...
pub const AppState = struct {
    ...
    fn setupAiOpponent(self: *AppState) usize {
        ...
        const plan = [_]AiPlanEntry{
            ...
            .{ .kind = .healing_pod, .x = support_x, .y = top_y },
            .{ .kind = .healing_pod, .x = support_x, .y = bottom_y },
            .{ .kind = .portal, .x = front_x, .y = top_y + 1 },
            .{ .kind = .portal, .x = midfield_x, .y = mid_y - 2 },
            .{ .kind = .portal, .x = midfield_x, .y = mid_y + 2 },
            ...
            .{ .kind = .captain, .x = deep_x, .y = top_y + 4 },
            .{ .kind = .artillery, .x = front_x, .y = top_y - 3 },
            .{ .kind = .infantry, .x = support_x, .y = top_y + 2 },
            ...
            .{ .kind = .infantry, .x = front_x, .y = upper_mid_y },
            .{ .kind = .infantry, .x = midfield_x, .y = mid_y - 4 },
            .{ .kind = .captain, .x = deep_x, .y = mid_y },
            ...
            .{ .kind = .infantry, .x = midfield_x, .y = bottom_y - 4 },
            .{ .kind = .artillery, .x = front_x, .y = bottom_y + 3 },
            .{ .kind = .infantry, .x = support_x, .y = bottom_y - 2 },
            .{ .kind = .infantry, .x = support_x, .y = upper_mid_y - 2 },
            .{ .kind = .infantry, .x = support_x, .y = lower_mid_y + 2 },
            .{ .kind = .captain, .x = core_x, .y = mid_y - 2 },
            .{ .kind = .artillery, .x = support_x, .y = mid_y + 3 },
            .{ .kind = .infantry, .x = core_x, .y = top_y + 4 },
            .{ .kind = .infantry, .x = core_x, .y = bottom_y - 4 },
            .{ .kind = .artillery, .x = support_x, .y = upper_mid_y },
        };
